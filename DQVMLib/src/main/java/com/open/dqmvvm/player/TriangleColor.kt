...
@Route(path = "/lib/triangle2")
class TriangleColor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        glsv.setRenderer(MTR2())
//        glsv.renderMode = GLSurfaceView.RENDERMODE_WHEN_DIRTY
    }
}

class MTR2 : GLSurfaceView.Renderer{
...
class ShapeT2 {
    ...
    fun draw(){
        ...
        GLES20.glVertexAttribPointer(matrix,2,GLES20.GL_FLOAT,false,8,shapeBuf)

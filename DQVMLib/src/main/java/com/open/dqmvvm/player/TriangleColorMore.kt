...
@Route(path = "/lib/triangle3")
class TriangleColorMore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        glsv.setRenderer(MTR3())
    }
}

class MTR3 : GLSurfaceView.Renderer{
...
class ShapeT3 {
    ...
    fun rotate(radio:Float){
        Matrix.rotateM(mMVPMatrix,0,radio,0f,1f,0f)
    }

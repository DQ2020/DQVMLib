...
@Route(path = "/lib/rec")
class TriangleRec : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        glsv.setRenderer(MTR4())
//        glsv.renderMode = GLSurfaceView.RENDERMODE_WHEN_DIRTY
    }
}

class MTR4 : GLSurfaceView.Renderer {
...
class ShapeT4 {
    ...
    fun draw() {
        ...
        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_STRIP, 0, shapeData.size / 3)

...
class TriangleMatrixTexture2 : AppCompatActivity() {
...
//            shape?.drawLine()
    ...
    inner class Shape {
        ...
        val indexBuffer = ByteBuffer.allocateDirect(indexArr.size * 4)
                .order(ByteOrder.nativeOrder())
                .asShortBuffer()
                .put(indexArr)
                .position(0)
...
//            GLES30.glDrawArrays(GLES30.GL_TRIANGLE_STRIP, 0, 4)
            GLES30.glDrawElements(GLES30.GL_TRIANGLES,indexArr.size,GLES30.GL_UNSIGNED_SHORT,indexBuffer)
